def option_a
  ...
  def option_b 
    puts "Give me a hoiliday."
    hoiliday1 = gets.chomp
    puts "Give me a verb."
    verb1 = gets.chomp
    puts "Give me a plural noun."
    ...
    puts "Give me a verb."
    verb2 = gets.chomp
    puts "Give me a verb that ends in 'ly'."
    verbly1 = gets.chomp
    puts = "Give me a noun."
    noun1 = gets.chomp
    ...
    puts "Give me a verb."
    verb3 = gets.chomp
    puts "Give me a meal of the day."
    meal1 =  
    ...
    puts "Today's #{holiday1}! I was so #{verb1}. See, every year, I get #{pluralnoun1}, but because I was #{verbing1}, I don't know if I'd get my reward again. Anyway, I #{verb2} up from my #{noun1} and #{verbly1} went downstairs. My #{person1} greeted me and #{verb3} me #{meal}."
def mad_libs
  puts "Hi there! Welcome to Mad Libs :) These are supposed to be funny but I honestly don't know how this is gonna go, so lets hope it goes well. Let's begin! Pick option a,b, or c!"
  option = gets.chomp
  if option == "a"
    puts option_a
  elsif option == "b"
